...
export const EditorCommentsComposer = () => {
  ...
  const convertCode = async (payLoad) => {
    try {
      const response = await axios.post(
        `http://localhost:5000/commentcomposer/generate_comments`,
        payLoad
      );
      setIsLoading(false);
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap justify-center items-center font-bold text-4xl p-10">
        ...
        <div className="font-bold text-2xl mb-2 pt-2 pr-4">Comment Composer</div>
          ...
          <p className="font-normal text-gray-700 dark:text-gray-400">
            ...
            <ol className="list-decimal ml-6">
              <li className="leading-relaxed">
                Type,paste or upload your code in the input box.
              </li>
              <li className="leading-relaxed">Click the generate button.</li>
              <li className="leading-relaxed">
                The resulting code with generated comments will be displayed in
                the output box.
              </li>
            </ol>
          </p>
